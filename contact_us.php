			...
			<div class="twelve columns">
							...
							<div class="block-title"><h2>CONTACT US</h2></div>	
								<div class="block-content align-justify">
									<p><b>SK TUTORIALS</b></p>
									<p>ADDRESS-SHOP NO.1,NEXT TO PMC BANK,RAJ RESIDENCY,</p>
									<p>BRAHMAND,,THANE(W)-400607</p>
									<p>CONTACTS: 08879259139</p>
									<p>EMAIL-sktutorials7@gmail.com</p>
								</div>
							</div>
				</div>	<!--twelve columns-->
